...
source ~/.profile
workon normal
mpiexec -np $PBS_NCPUS python map_collection.py -i mammals.GNC_rooted_sims -b $DB_HOST -L DEBUG -f ml.rooted -o mammals.GNC_rooted_sims_fits -k ../config/GNC_rooted.json -s
